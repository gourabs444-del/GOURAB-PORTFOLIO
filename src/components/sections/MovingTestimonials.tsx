  ...
  const renderCard = (t: Testimonial, keyId: string) => {
    ...
    return (
      <div
        ...
        className="relative w-[320px] sm:w-[380px] md:w-[410px] shrink-0 p-5 sm:p-6 rounded-2xl border border-white/[0.08] hover:border-white/20 bg-[#0c0e14]/95 backdrop-blur-md shadow-xl transition-all duration-300 hover:-translate-y-1 select-none flex flex-col justify-between gap-3.5 group/card"
      >
        {/* Subtle Card Glow on Hover */}
        <div
          className="pointer-events-none absolute inset-0 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 rounded-2xl"
          style={{
          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-1.5 text-xs text-neutral-400">
                ...
                <span className="font-semibold text-white group-hover/card:text-emerald-300 transition-colors truncate">
                  {t.author}
                </span>
              </div>
        ...
        <div className="pt-2.5 border-t border-white/[0.06] flex items-center justify-between relative z-10 text-xs">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <div className="flex items-center gap-1 font-mono text-[11px] text-neutral-400 group-hover/card:text-rose-300 transition-colors">
